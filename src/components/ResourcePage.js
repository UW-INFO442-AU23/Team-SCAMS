    ...
    return(
        <div className='container'> 
            ...
            <div class="container callout_container rounded py-4 my-5">
                ...
                <p class="text-center">Are you viewing this website on your computer through Chrome? Did you know that <a
                        href="https://googleblog.blogspot.com/2009/01/powering-google-search.html">every
                        Google search produces around 0.2 grams of carbon dioxide</a>? Here are a couple of alternate web
                    browsers
            ...
            <p class="text-center">Take our Knowledge Quiz to see how much you know!</p>
